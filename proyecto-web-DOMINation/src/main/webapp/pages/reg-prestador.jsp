...
<body>
    ...
    <form name="form3" action="register" method="post" >
        ...
        <label class="fuenteMin" for="name">Nombre:</label> <input type="text" id="nombre" name="nomCliente" >       
        <label class="fuenteMin" for="last-name">Apellido:</label> <input type="text" id="apellido" name="apellido">  
        <label class="fuenteMin" for="nroCuil">CUIL:</label> <input type="text" id="CUIL" name="CUIL">
